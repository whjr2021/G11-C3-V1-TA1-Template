...
while carryOn:
    ...
    # Check if a key is pressed  
        ...
        # Check if key pressed is right key
        
            # Check if paddle's x-coordinate is less than 540
            
                # Increase paddle's x position by the value in 'paddlex'
    ...
    # Check for paddle and ball collision using "collidepoint()" function
    
        # If collision has happened change ball direction by negating the sign of "bally"
